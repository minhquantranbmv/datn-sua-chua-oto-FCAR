@extends('admin.layouts.main') @section('content') {{-- <button>Xuất hóa đơn</button> --}}




<div class="container" style="background-color: white">
    @can('list-booking') @if ($booking_detail->list_bill)
    <a name="" id="" class="btn btn-primary" target="_blank" href="{{ route('dat-lich.xuat-hoa-don', ['booking_detail_id'=>$booking_detail->id]) }}" role="button"> Xuất hóa
        đơn</a> @endif @endcan
    ...
    <table class="table">
        ...
        <tbody>
            ...
            <tr>
                ...
                <th id="tong"> {{ number_format( array_sum(array_column($repair_parts->toArray(),'into_money')),0, ',', '.' ) }} VND</th>
            </tr>
            {{--
            <tr>
                <td></td>
                    ...
                    <div class="form-group">
                        <form action="" method="POST" id="form_tien_khach_tra">
                            ...
                            <input type="number" onchange="tinhTien()" value="@if (!empty($list_bill->customers_pay))
                                    ...
                                    @endif" class="form-control col-4" name="customers_pay" id="" aria-describedby="helpId" placeholder=" VND">
                        </form>
                    </div>
                </th>
            </tr> --}} {{--
    ...
    @can('list-booking')
    <button form="form_tien_khach_tra" type="submit" class="btn btn-success">Lưu Hóa Đơn</button> @endcan
</div>
